  ...
  return (
    ...
    >
      ...
      <div className="content">
        <h1 className="title text-[32px] md:text-[80px] 2xl:text-[110px] font-semibold text-[#FFFFFF] text-opacity-90">
          <>
            探索 AI 给予
            <br />
            数据标注的全新方式
        ...
        <h2 className="text-[10px] md:text-[18px] 2xl:text-[20px] text-[#FFFFFF] text-opacity-40">
          <>
            <p className="mt-4">
